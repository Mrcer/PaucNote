...
3. 关于x,y右连续
4. 落在某个矩形的概率大于零
	$\forall (x_1,y_1),(x_2,y_2),x_1<x_2,y_1<y_2,不等式F(x_2,x_y)-F(x_2,y_1)-F(x_1,y_2)+F(x_1,y_1)成立$）
...
4. 若f(x,y)在(x,y)连续，则有F(x,y)的xy导数等于f(x,y)，并由此得出(x,y)附近的小矩形概率等于$f(x,y)\Delta x\Delta y$
